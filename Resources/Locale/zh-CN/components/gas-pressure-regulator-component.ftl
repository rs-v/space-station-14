# UI Labels
gas-pressure-regulator-ui-set-threshold = 设置
gas-pressure-regulator-ui-zero-threshold = 清零
gas-pressure-regulator-ui-set-to-current-pressure = 设为进气压力
...
gas-pressure-regulator-ui-title = 进气压力调节器
gas-pressure-regulator-ui-target = 设定值
gas-pressure-regulator-ui-flow = 流量
gas-pressure-regulator-ui-outlet = 出口
gas-pressure-regulator-ui-inlet = 进口
