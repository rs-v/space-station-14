...
marking-ScarTopSurgeryShort-scar_top_surgery_short = 上胸手术疤痕
marking-ScarTopSurgeryShort = 上胸手术疤痕（短）

marking-ScarTopSurgeryLong-scar_top_surgery_long = 上胸手术疤痕
marking-ScarTopSurgeryLong = 上胸手术疤痕（长）

marking-ScarChest-scar_chest = 胸部疤痕
marking-ScarChest = 胸部疤痕

marking-ScarNeck-scar_neck = 颈部疤痕
marking-ScarNeck = 颈部疤痕

marking-ScarChestBullets-scar_chest_bullets = 弹孔疤痕
marking-ScarChestBullets = 胸部疤痕（弹孔）
