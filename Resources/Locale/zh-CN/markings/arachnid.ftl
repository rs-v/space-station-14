...
marking-ArachnidCheliceraeInwards = 螯肢（向内）
...
marking-ArachnidAppendagesFreaky = 附肢（超长）
...
marking-ArachnidTorsoStripes-stripes = 图案

marking-ArachnidTorsoSlashes = 斜线
marking-ArachnidTorsoSlashes-slashes = 图案

marking-ArachnidTorsoCross = 十字
marking-ArachnidTorsoCross-cross = 图案

marking-ArachnidTorsoX = X形
marking-ArachnidTorsoX-x = 图案

marking-ArachnidTorsoHeart = 心形
marking-ArachnidTorsoHeart-heart = 图案

marking-ArachnidTorsoHourglass = 沙漏形
marking-ArachnidTorsoHourglass-hourglass = 图案

marking-ArachnidTorsoNailAndHammer = 钉与锤
marking-ArachnidTorsoNailAndHammer-nail-and-hammer = 图案

marking-ArachnidTorsoStar = 星形
marking-ArachnidTorsoStar-star = 图案

marking-ArachnidTorsoArrows = 箭头
marking-ArachnidTorsoArrows-arrows = 图案

marking-ArachnidTorsoCore = 核心
marking-ArachnidTorsoCore-core = 图案

marking-ArachnidTorsoFiddleback = 提琴背纹
marking-ArachnidTorsoFiddleback-fiddleback = 图案

marking-ArachnidTorsoSkull = 骷髅
marking-ArachnidTorsoSkull-skull = 图案

marking-ArachnidTorsoTarget = 靶心
marking-ArachnidTorsoTarget-target = 图案

marking-ArachnidRArmStripes = 蛛形类条纹（右）
marking-ArachnidRArmStripes-stripes_right = 条纹

marking-ArachnidLArmStripes = 蛛形类条纹（左）
marking-ArachnidLArmStripes-stripes_left = 条纹

marking-ArachnidRLegStripes = 蛛形类条纹（右）
marking-ArachnidRLegStripes-stripes_right = 条纹

marking-ArachnidLLegStripes = 蛛形类条纹（左）
marking-ArachnidLLegStripes-stripes_left = 条纹

marking-ArachnidOverlayFuzzy = 绒毛
