wires-panel-component-on-examine-open = [color=lightgray]维护面板[/color]是[color=red]打开的[/color]。
wires-panel-component-on-examine-closed = [color=lightgray]维护面板[/color]是[color=darkgreen]关闭的[/color]。
...
wire-name-color-navy = 深蓝
wire-name-color-purple = 紫色
wire-name-color-pink = 粉色
wire-name-color-fuchsia = 品红
